...
class CouplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create couple" do
    assert_difference('Couple.count') do
      post couples_url, params: { couple: { category: @couple.category, groom_id: @couple.groom_id } }
    end
  ...
  test "should update couple" do
    patch couple_url(@couple), params: { couple: { category: @couple.category, groom_id: @couple.groom_id } }
